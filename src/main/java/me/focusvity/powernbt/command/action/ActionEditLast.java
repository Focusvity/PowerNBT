...
public class ActionEditLast extends Action
{
    ...
    public ActionEditLast(Caller caller, String firstObject, String firstParam, String secondObject, String secondParam)
    {
        this.caller = caller;
    ...
    public void execute() throws Exception
    {
        ...
        {
            throw new RuntimeException("Cannot change value by query " + secondQuery.toString(), ex);
        }
    }
}
