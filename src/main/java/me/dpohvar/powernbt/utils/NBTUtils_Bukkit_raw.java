...
final class NBTUtils_Bukkit_raw extends NBTUtils
{
    ...
    private RefClass class_NBTCompressedStreamTools = getRefClass("{nms}.NBTCompressedStreamTools, {NBTCompressedStreamTools}");
    ...
    private RefClass class_NBTTagLongArray = getRefClass("{nms}.NBTTagLongArray, {NBTTagLongArray}");
    ...
    private RefConstructor con_NBTagLongArray = class_NBTTagLongArray.getConstructor(long[].class);
    ...
    {
        return con_NBTagLongArray.create(new Object[]{a});
    }
